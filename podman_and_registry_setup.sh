...
#DOWNLOAD AND RUN SCRIPT LOCALLY
...
#Setup password for cloud_user on registry.
read -sp 'cloud_user password: ' PASSWORD
echo
echo "setting up cloud_user in registry"
htpasswd -bBc /opt/registry/auth/htpasswd cloud_user `echo $PASSWORD`
